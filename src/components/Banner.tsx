      ...
      <div className="w-full md:px-4 lg:mx-auto lg:px-8 xl:w-[1170px]">
        <div className=" w-full items-center md:flex md:pb-[32px]">
          ...
          <div
            id="home"
            className={cn(
              "ml-[40px] mr-[100px] min-w-[300px] py-[20px] md:ml-0 lg:m-0",
          ...
          >
            ...
            <p className="text-sm xl:text-base">
              ...
              familiares, os momentos mais marcantes da nossa história de amor.
              A contagem regressiva, o frio na barriga e toda a ansiedade do dia
